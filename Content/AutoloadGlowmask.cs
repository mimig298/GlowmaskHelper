...
/// <para/> The glowmask texture will be autoloaded from <see cref="Terraria.ModLoader.ModItem.Texture"/> + "_Glow". An error will be thrown if this texture is not found.
/// </summary>
